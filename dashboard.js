...
import { html, Avatar, money, niceDate, niceTime, mediaUrl, todayStr } from "./ui.js?v=25";
import { EventsPage } from "./events.js?v=25";
import { AnnouncementsPage } from "./announcements.js?v=25";
import { MembersPage } from "./members.js?v=25";
import { MoneyPage } from "./money.js?v=25";
import { SettingsPage } from "./settings.js?v=25";
import { PartnershipsPage } from "./partnerships.js?v=25";
