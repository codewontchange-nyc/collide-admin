...
import { html, Avatar, money, niceDate, niceTime, mediaUrl, todayStr } from "./ui.js?v=36";
import { EventsPage } from "./events.js?v=36";
import { AnnouncementsPage } from "./announcements.js?v=36";
import { MembersPage } from "./members.js?v=36";
import { MoneyPage } from "./money.js?v=36";
import { SettingsPage } from "./settings.js?v=36";
import { PartnershipsPage } from "./partnerships.js?v=36";
