...
import { html, Avatar, money, niceDate, niceTime, mediaUrl, todayStr } from "./ui.js?v=24";
import { EventsPage } from "./events.js?v=24";
import { AnnouncementsPage } from "./announcements.js?v=24";
import { MembersPage } from "./members.js?v=24";
import { MoneyPage } from "./money.js?v=24";
import { SettingsPage } from "./settings.js?v=24";
import { PartnershipsPage } from "./partnerships.js?v=24";
