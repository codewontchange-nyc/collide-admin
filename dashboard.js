...
import { html, Avatar, money, niceDate, niceTime, mediaUrl, todayStr } from "./ui.js?v=8";
import { EventsPage } from "./events.js?v=8";
import { AnnouncementsPage } from "./announcements.js?v=8";
import { MembersPage } from "./members.js?v=8";
import { MoneyPage } from "./money.js?v=8";
import { SettingsPage } from "./settings.js?v=8";
import { PartnershipsPage } from "./partnerships.js?v=8";
